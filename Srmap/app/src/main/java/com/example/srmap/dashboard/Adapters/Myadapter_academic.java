...
public class Myadapter_academic extends RecyclerView.Adapter<Myadapter_academic.MyViewHolder> {
    List<User_itsupport> user_itsupports;
    Context context;

    public Myadapter_academic(List<User_itsupport> user_itsupports, Context context) {
