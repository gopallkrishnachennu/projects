...
public class Myadapter_notification extends RecyclerView.Adapter<Myadapter_notification.MyViewHolder> {
    List<User_itsupport> user_itsupports;
    Context context;

    public Myadapter_notification(List<User_itsupport> user_itsupports, Context context) {
