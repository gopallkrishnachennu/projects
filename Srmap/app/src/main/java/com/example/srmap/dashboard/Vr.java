...
public class Vr extends AppCompatActivity {
   ...
   String boys="https://www.google.com/maps/@16.46485,80.5075602,3a,90y,335.39h,86.63t/data=!3m7!1e1!3m5!1sAF1QipPd9bnDNbUUp013dXi_xkcH_O-gEi11W99LpGn2!2e10!3e12!7i13000!8i6500";
    String vrreception=" https://www.google.com/maps/@16.4647319,80.5078021,3a,52.4y,87.47h,89.53t/data=!3m7!1e1!3m5!1sAF1QipM7fSfLFkiC5HJ77pZ7pqDc7lvI0z0uBCkA6nkb!2e10!3e12!7i13000!8i6500 ";
    String vrclassroom="";

    String vrlab="https://www.google.com/maps/@16.4649842,80.5078784,3a,52.4y,53.41h,88.06t/data=!3m7!1e1!3m5!1sAF1QipPoxgzjyhVW4jMyLVkJVqJFmNl_rNKPOHhqWXkJ!2e10!3e12!7i13000!8i6500";
    ...
    private void click() {
        ...
        uservrList.add(new Uservr(R.drawable.ladieshostel,"Girls Hostel & Gym",girls));
        uservrList.add(new Uservr(R.drawable.gentshostel,"Boys Hostel & Gym",boys));
       uservrList.add(new Uservr(R.drawable.labs_classrooms,"E-Lab",vrlab));

       uservrList.add(new Uservr(R.drawable.labs_classrooms,"Classroom",vrclassroom));
        uservrList.add(new Uservr(R.drawable.digital_classroom,"Digital Clasroom",vrdigitalclassroom));
        ...
        uservrList.add(new Uservr(R.drawable.music_room,"Music Room",vrmusic));
        uservrList.add(new Uservr(R.drawable.table_tennis,"Tabel Tennis",vrtabletennis));
